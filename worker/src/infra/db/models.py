...
class Document(BaseModel):
    ...
    file_url: Mapped[str] = mapped_column(String(length=512), unique=True, nullable=False)
    report_url: Mapped[str] = mapped_column(String(length=512), unique=True, nullable=True)
    ...
    authors: Mapped[List["Author"]] = relationship(secondary=document_authors, back_populates="documents")
...
class Author(BaseModel):
    ...
    documents: Mapped[List["Document"]] = relationship(secondary=document_authors, back_populates="authors")
